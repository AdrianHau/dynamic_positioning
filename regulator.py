...
class PID:
    ...
    def calculate_output(self, current_pos):
        ...
        dt = (current_time - self.previous_time) if self.previous_time is not None else 0  # find a better fix
        ...
        self.derivative_term = self.Kd * de/dt if dt is not 0 else 0  # find a better fix
